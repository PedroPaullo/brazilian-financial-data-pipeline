...
4. Data coverage: historical expected-versus-actual coverage by source and calendar.
5. Observability: operational SQLite in `data/operations/pipeline_operations.db`.
6. Consumption: Excel report and Streamlit dashboard.
7. Automation: APScheduler and the master command `src/run_pipeline.py`.
